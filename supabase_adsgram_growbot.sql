...
-- Watch Reward block: 49601 -> +6 points, max 20 rewards per Baghdad day.
-- Native Task block: task-49603 -> +1 point each completed native task.
...
values
  ('adsgram_reward_block_id', '49601'),
  ('ads_daily_limit', '20'),
  ('ads_reward_points', '6'),
  ('adsgram_native_task_block_id', 'task-49603'),
