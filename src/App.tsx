...
// نطبّق المظهر المحفوظ (داكن افتراضيًا) قبل أول رسم للواجهة حتى ما
// يصير وميض/قفزة لون عند فتح التطبيق
applyTheme('dark')

const ADSGRAM_AUTO_BLOCK_ID = 'int-49602'
...
export default function App() {
  ...
  // شاشة تحميل Stormy (خلفية + شريط تقدّم) — تبقى ظاهرة لحد ما يخلص
