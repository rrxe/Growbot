    ...
    <section className="page">
      ...
      <div className="publish-warning">
        ...
        <div>
          ...
          <p>
            تأكد من إضافة بوت Stormy كمشرف في القناة أو المجموعة قبل النشر.
      ...
      {type === 'bot' ? (
        <>
          ...
          <div className="field-section">
            ...
            <textarea
              ...
              placeholder="مثال: افتح البوت واضغط ابدأ ثم أكمل الخطوة المطلوبة."
              maxLength={500}
              rows={3}
            />
        ...
        <div className="field-section">
          ...
          <small className="field-help">
            أدخل رابط Telegram أو @username، وتأكد أن بوت Stormy مشرف في الوجهة حتى يتم التحقق من الانضمام.
          </small>
        </div>
      )}
