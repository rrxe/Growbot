    ...
    <section className="page">
      ...
      <div className="publish-warning">
        ...
        <div>
          ...
          <p>
            لازم تضيف GrowBot كـAdmin في القناة
            أو المجموعة قبل نشر المهمة.
            بدون صلاحية الإدارة لن نقدر نتحقق من
            العضوية ولن يتم قبول المهمة.
          </p>
        </div>
      ...
      <div className="field-section">
        ...
        <small className="field-help">
          يمكنك وضع رابط Telegram أو @username.
          يشترط أن يكون البوت Admin في المكان.
        </small>
      </div>
